...
export default async function oneProduct(): Promise<Product[]> {
    // @ts-ignore
    const commentsOne = window.globalVariablePostOneComments || [];
    ...
    // @ts-ignore
    const commentsTwo = window.globalVariablePostTwoComments || [];
